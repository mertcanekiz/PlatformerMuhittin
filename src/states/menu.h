...
public:
	...
	void loadImages() { if(image0 == nullptr) image0 = Graphics::loadTexture("res/menu/buttons/" + name + "0.png");
						if(image1 == nullptr) image1 = Graphics::loadTexture("res/menu/buttons/" + name + "1.png");}
